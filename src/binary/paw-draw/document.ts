import {CancellationToken, CustomDocument, CustomDocumentBackup, Disposable, EventEmitter, Uri, workspace} from 'vscode'
import PawDrawDocumentDelegate from './model/document-delegate'
import PawDrawEdit from './model/edit'

export class PawDrawDocument implements CustomDocument {
