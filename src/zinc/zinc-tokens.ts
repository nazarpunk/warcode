...
>, TokenType> = {
    ...
    [ZincRule.add_assign]: operator(ZincRule.add_assign, '+='),
    [ZincRule.add]: operator(ZincRule.add, '+'),
    [ZincRule.sub_assign]: operator(ZincRule.sub_assign, '-='),
    [ZincRule.sub]: operator(ZincRule.sub, '-'),
    [ZincRule.mult_assign]: operator(ZincRule.mult_assign, '*='),
    [ZincRule.mult]: operator(ZincRule.mult, '*'),
    [ZincRule.div_assign]: operator(ZincRule.div_assign, '/='),
