...
var ZincVisitor = class extends ParserVisitor {
  ...
  [zinc_rule_default.library_declare](ctx) {
    ...
    const b = this?.bridge;
    if (b) {
      b.mark(ctx[zinc_rule_default.library]?.[0], token_legend_default.jass_function);
      b.mark(ctx[zinc_rule_default.identifier]?.[0], token_legend_default.jass_function_user);
      b.mark(ctx[zinc_rule_default.lcurlyparen]?.[0], token_legend_default.jass_lparen);
      b.mark(ctx[zinc_rule_default.rcurlyparen]?.[0], token_legend_default.jass_rparen);
    }
  }
  [zinc_rule_default.access_scope](ctx) {
    ...
    const b = this?.bridge;
    if (b) {
      b.mark(ctx[zinc_rule_default.public]?.[0], token_legend_default.jass_constant);
      b.mark(ctx[zinc_rule_default.private]?.[0], token_legend_default.jass_constant);
      b.mark(ctx[zinc_rule_default.lcurlyparen]?.[0], token_legend_default.jass_lparen);
      b.mark(ctx[zinc_rule_default.rcurlyparen]?.[0], token_legend_default.jass_rparen);
    }
  }
  ...
  [zinc_rule_default.variable_declare](ctx) {
    ...
    if (b) {
      ...
      b.mark(ctx[zinc_rule_default.public]?.[0], token_legend_default.jass_constant);
      b.mark(ctx[zinc_rule_default.private]?.[0], token_legend_default.jass_constant);
      b.mark(ctx[zinc_rule_default.semicolon]?.[0], token_legend_default.jass_comma);
